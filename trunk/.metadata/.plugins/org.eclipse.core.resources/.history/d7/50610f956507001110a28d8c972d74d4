...
{
	public static void lily_Get_ContentOfSomeThemePage_InLatestDate(String subforum,int new_page,Date begin_date,Date end_date)throws IOException,ClassNotFoundException,SQLException,InterruptedException
	{	
		ArrayList<String> all_theme_url=Lily_GetThemePageUrl_OfNewFramePage.lily_GetThemePageUrl_OfNewFramePage(subforum,new_page,0);
...
*/		if(begin_date.after(end_date))
		...
		for(int i=0;i<all_theme_url.size();i++)
		{
			...
			ArrayList<String> temp_arr=Lily_Content_Analyzer.lily_Content_Analyzer(all_theme_url.get(i));
	//	System.out.println(temp_arr.get(2));
			Thread.sleep(1000);
			Date theme_date=date_Analyzer(temp_arr.get(2));
			
			if(temp_arr.get(2)!=""&&theme_date.before(end_date)&&theme_date.after(begin_date))
			{
	...
	{
		String temp_str="";
		if(month_str.equals("Jen"))temp_str="0";
		else if(month_str.equals("Feb"))temp_str="1";
		else if(month_str.equals("Mar"))temp_str="2";
		else if(month_str.equals("Apr"))temp_str="3";
		else if(month_str.equals("May"))temp_str="4";
		else if(month_str.equals("Jun"))temp_str="5";
		else if(month_str.equals("Jul"))temp_str="6";
		else if(month_str.equals("Aug"))temp_str="7";
		else if(month_str.equals("Sep"))temp_str="8";
		else if(month_str.equals("Oct"))temp_str="9";
		else if(month_str.equals("Nov"))temp_str="10";
		else if(month_str.equals("Dec"))temp_str="11";
	...
	public static void main(String[] args)throws IOException,ClassNotFoundException,SQLException,InterruptedException
	{
		...
		int new_page=2;
		lily_Get_ContentOfSomeThemePage_InLatestDate(url,new_page,begin_date,end_date);
	}

...
public class Update_OneDiscussion {
	public static void update_OneDiscussion(String discussion_name)
			throws IOException, ClassNotFoundException, SQLException,
			InterruptedException {
		ArrayList<String> all_subforum = Lily_Get_AllSubForumName
				.lily_Get_SubForumName(discussion_name);
	...
	public static void main(String[] args) throws IOException,
		...
		ArrayList<String> all_subforum = Lily_Get_AllSubForumName
				.lily_Get_SubForumName(discussion);

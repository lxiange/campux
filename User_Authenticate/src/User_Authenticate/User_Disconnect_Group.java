...
public class User_Disconnect_Group
{
	public static String user_Disconnect_Group(Document document,DynamicTable_RCL ran_con,String app_path_prefix)
	{
		String response="";
		...
		//错误13：user_group表中不存在(user_name,group_name)项
		if(Connect_DBTable_UG.have_ItemInUG(user_name,group_no)==false)
		{
			response=Connect_DBTable_WS.wrong_Response("13"); 
			return response;
		}
		//错误40：group_no为"app"
		...
		Connect_DBTable_UG.delete_ItemInUG(user_name, group_no,"");
